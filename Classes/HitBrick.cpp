...
bool HitBrick::init() 
{
	...
	auto boundBody = PhysicsBody::createEdgeBox(visibleSize, PhysicsMaterial(0.0f, 1.0f, 0.0f), 3);  /*用edgebox来设置界面边界*/
	edgeSp->setPosition(visibleSize.width / 2, visibleSize.height / 2);  /*把位置设置在屏幕中间*/
